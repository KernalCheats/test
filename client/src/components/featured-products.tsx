...
export default function FeaturedProducts() {
  ...
  if (isLoading) {
    return (
      <section id="products" className="py-20 bg-dark-gray">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Discover our most popular and powerful gaming enhancement tools, 
            designed for competitive advantage and enhanced gameplay experience.
          </p>
        </div>
        ...
        <div className="text-center mt-12">
          <Link href="/products">
            <button className="bg-transparent border-2 border-neon-purple text-neon-purple px-8 py-4 rounded-lg font-bold text-lg hover:bg-neon-purple hover:text-black transition-all duration-300 transform hover:scale-105">
